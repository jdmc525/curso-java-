 ...
 */
package com.mycompany.eqcuadratica_keyreleased;
import java.text.DecimalFormat;
/**
 *
 * @author Daniel
 */
public class EqCuadrKey extends javax.swing.JFrame {

    //FUNCIONES
    //Funcion para calcular el valor en una sola instruccion mientras el usuario va poniendo valores en las cajas
    public void calcular(){
     try{
            double discr, x11, x22;
            ...
            if (discr>=0 && a!=0) {
                ...
                x1.setText( f.format(x11));
                x2.setText( f.format(x22));
            
            }else{
               x1.setText("ERROR, respuesta compleja");
               x2.setText("");
            }
        }
        catch(Exception ex){
           x1.setText("ERROR revise valores");
           x2.setText("");
    ...
    private void initComponents() {
        ...
        jLabel2.setText("CALCULAR ECUACION CON FORMULA CUADRATICA con key released");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EqCuadrKey.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EqCuadrKey().setVisible(true);
            }
        });
    }
